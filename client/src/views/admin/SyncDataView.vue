...
const tabs = computed(() => [
  ...
  { type: 'sessions', label: t('admin.tab_sessions') },
...
const columnDefs = {
  ...
  ammo: [
    ...
    { key: 'cost_per_round', label: 'Cost/Rnd' },
  ...
  sessions: [
    ...
    { key: 'total_x_count', label: 'X Count' },
    { key: 'modified_at', label: t('admin.sync_modified_at'), type: 'datetime' },
  ],
  competitions: [
    { key: 'name', label: 'Name' },
...
const fieldDefs = {
  ...
  ammo: [
    ...
    { key: 'cost_per_round', label: 'Cost Per Round', type: 'number' },
    { key: 'current_stock', label: 'Current Stock', type: 'number' },
    { key: 'notes', label: 'Notes', type: 'textarea' },
    { key: 'is_archived', label: 'Archived', type: 'boolean' },
  ],
  sessions: [
    { key: 'date', label: 'Date', inputType: 'datetime-local' },
    { key: 'end_date', label: 'End Date', inputType: 'datetime-local' },
    { key: 'discipline_name', label: 'Discipline' },
    { key: 'type', label: 'Type' },
    { key: 'location', label: 'Location' },
    { key: 'notes', label: 'Notes', type: 'textarea' },
    { key: 'total_score', label: 'Total Score', type: 'number' },
    { key: 'total_x_count', label: 'X Count', type: 'number' },
    { key: 'weapon_uuid', label: 'Weapon UUID' },
    { key: 'ammo_uuid', label: 'Ammo UUID' },
  ],
  competitions: [
    { key: 'name', label: 'Name' },
